...
// my-module.js
exports.command = ['sd', 'strip-dependencies']

exports.describe = 'DEV - removes all dependecies that already ship with ufp-core from current package'
...
exports.handler = function (argv) {
    ...
    console.warn('Stripping dependencies that are provided with ufp-core')

    child_process.execSync(`node ${path.join(__dirname, '../../ext/')}RemovePackagesThatAreInUFPCore.js`, {
        cwd: process.cwd(),
        stdio: 'inherit'
    })
}
