...
var StartupConfiguration = function () {
    ...
    (0, _createClass3.default)(StartupConfiguration, [{
        key: 'init',
        value: function init() {
            (0, _epic.registerEpic)({ epic: _StartupEpic2.default.startupInit });
            (0, _epic.registerEpic)({ epic: _StartupEpic2.default.startupStep });
            (0, _epic.registerEpic)({ epic: _StartupEpic2.default.startupFinish });
        }
    }, {
