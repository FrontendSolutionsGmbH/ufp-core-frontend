...
import _StartupConstants from './model/StartupConstants'
...
export const StartupConstants = _StartupConstants
export const HOCLoader = _HOCLoader

export const StartupConfiguration = _StartupConfiguration
export const StartupConfigurator = _StartupConfiguration
